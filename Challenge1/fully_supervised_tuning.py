...
grid_search_SVC.fit(X_train_reduced.view(-1, 28*28), y_train_reduced)
with open('tuning/fully_supervised/grid_search_SVC.pkl', 'wb') as file:
    pickle.dump(grid_search_SVC, file)
with open('models/fully_supervised/best_SVC.pkl', 'wb') as file:
...
net = NeuralNetClassifier(
    ...
    module__output_dim=th.unique(y_train_reduced).shape[0],           
...
grid_search_FCNN.fit(X_train_reduced.view(-1, 28*28), y_train_reduced)
with open('tuning/fully_supervised/grid_search_FCNN.pkl', 'wb') as file:
    pickle.dump(grid_search_FCNN, file)
with open('models/fully_supervised/best_FCNN.pkl', 'wb') as file:
...
grid_search_CNN.fit(X_train_reduced, y_train_reduced)
with open('tuning/fully_supervised/grid_search_CNN.pkl', 'wb') as file:
    pickle.dump(grid_search_CNN, file)
with open('models/fully_supervised/best_CNN.pkl', 'wb') as file:
